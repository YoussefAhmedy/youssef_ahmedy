      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          <div className="space-y-4">
            ...
            >
              I architect and develop robust full-stack applications with microservices design, bringing scalable and secure solutions to complex enterprise environments.
            </motion.p>
          </div>
          ...
          <div className="relative h-[400px] w-full">
            ...
            >
              <div className="bg-accent border-4 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <p className="text-lg font-bold text-white">15+ Projects</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
