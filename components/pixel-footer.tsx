...
export function PixelFooter() {
  ...
  const socialLinks = [
    { icon: <GithubIcon size={24} />, href: "https://github.com/YoussefAhmedy", label: "GitHub" },
    { icon: <TwitterIcon size={24} />, href: "https://x.com/Youssef1893?s=09", label: "Twitter" },
    { icon: <InstagramIcon size={24} />, href: "https://www.instagram.com/youssef_ahmedy/", label: "Instagram" },
    { icon: <LinkedinIcon size={24} />, href: "https://www.linkedin.com/in/youssef-ahmedy-76711a2a4", label: "LinkedIn" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold">Youssef Ahmedy</h3>
            </div>
            <p className="text-lg">
